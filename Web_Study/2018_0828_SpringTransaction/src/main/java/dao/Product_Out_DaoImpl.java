...
public class Product_Out_DaoImpl implements ProductDao {
	...
	public List<ProductVo> list() {
		...
		list = session.selectList("product_out.product_out_list");
	...
	public int insert(ProductVo vo) throws Exception {
		...
		int res = session.insert("product_out.product_out_insert", vo);
	...
	public int delete(int idx) {
		...
		res = session.delete("product_out.product_out_delete", idx);
