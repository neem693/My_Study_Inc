...
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/resources/css/photo_list.css"></link>
...
var g_idx;
	...
	function download(filename) {
		...
		location.href = "${pageContext.request.contextPath}/photo/FileDownload.do?dir=/resources/image/&filename="
				+ filename;
	}
	function modi(f) {
			...
			<c:forEach var="vo" items="${list}">
				<form method="POST">
					<div class="photo_type">
						<img alt=""
							src="${pageContext.request.contextPath}/resources/image/${vo.filename}">
