	...
	function comment_send() {
		if ('${empty user}' == 'true') {
			...
			if (confirm('댓글은 로그인 하신후에 사용가능합니다\n로그인 하시겠습니까?')) {
				location.href = '${pageContext.request.contextPath}/resources/member/login_form.do?url='
...
${user.name}(${user.id})님 환영합니다.
	...
	<table width="690" height="50" border="0" cellpadding="0"
		cellspacing="0">
		<tr>
			<td><input type="image" src="${pageContext.request.contextPath}/resources/img/title_04.gif"
			...
			<tr>
				<td><input type="image" src="${pageContext.request.contextPath}/resources/img/btn_list.gif"
					...
					style="cursor: pointer;"> <c:if test="${not empty user}">
						...
						<input type="image" src='${pageContext.request.contextPath}/resources/img/btn_delete.gif'
				...
				<tr>
					<td>
						<table width="690" height="50" border="0" cellpadding="0"
							cellspacing="0">
							<tr>
								<td><img src="${pageContext.request.contextPath}/resources/img/title_04.gif" class="title"
									onclick="location.href = 'list.do'"></td>
							</tr>
						</table> <!--타이틀 영역--끝-->
					</td>
									...
									<table width="690" border="0" cellspacing="0" cellpadding="0">
										<tr>
											...
											<td width="2" class="td_b"><img
												src="${pageContext.request.contextPath}/resources/img/td_bg_01.gif"></td>
